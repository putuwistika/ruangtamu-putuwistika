...
/**
 * Runner Queue Component
 * View queue and take guests to tables
 */
const RunnerQueue = () => {
  // Auth
  const { user } = useAuth();
  ...
  const fetchQueue = async (silent = false) => {
    try {
      ...
      if (!silent && queueData.length > 0) {
        toast.success(`${queueData.length} guest(s) in queue`);
      }
    } catch (error) {
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    View guests waiting in queue and take them to their tables
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-700">
                        ...
                        longest. Auto-refresh updates the queue every{' '}
                        {POLL_INTERVALS.QUEUE / 1000} seconds.
                      </p>
                    </div>
                  </div>
                </Card>
